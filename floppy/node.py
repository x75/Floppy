...
def createNode(name, baseClass, inputs, outputs, setupCodeString, runCodeString):
    """
    Creates a Node class from serialized data. This function is used to create Node classes from the data
    generated by the NodeWizard.
    :return: Instance of MetaNode
    """
    NodeClass = MetaNode(name, (baseClass,), {})
